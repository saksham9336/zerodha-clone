        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customers trust TradeVista with 3.5+ lakh crores worth of equity investments.</p>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                       ...
                       <a href='' style={{textDecoration: "none"}}>Try Vista demo <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
